...
class Score_Evaluation:
    ...
    def score_evaluate(self, ear_score, gaze_score, head_roll, head_pitch, head_yaw):
        """
        ...
        # print("The ear_score is ", ear_score)
        ...
        # print("The gaze_score is ", gaze_score)
        # if gaze_score is not None:
            # if gaze_score <= 1.2:
            #     left = True
            # # elif gaze_score >= 2 and gaze_score <= 4.5:
            # #     center = True
            # elif gaze_score >= 5.5:
            #     right = True
        ...
        return asleep, looking_away, distracted, right, center, left
